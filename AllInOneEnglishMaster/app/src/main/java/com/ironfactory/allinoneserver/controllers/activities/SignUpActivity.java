...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idView = (AutoCompleteTextView) findViewById(R.id.email);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            SocketManager.signUp(id, password, new RequestListener.OnSignUp() {
                @Override
                public void onSuccess() {
                    showProgress(false);
                    Toast.makeText(getApplicationContext(), "회원 추가에 성공했습니다.", Toast.LENGTH_SHORT).show();
                    finish();
                }
                ...
                public void onException(int code) {
                    showProgress(false);
                    Toast.makeText(getApplicationContext(), "회원 추가에 실패했습니다.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
